...
public class FindSmallestAndLargest {
    ...
    public static int[] findSmallestAndLargest(int number1, int number2,
int number3){
//creating array of size to for storing smallest and largest
...
//store result of mathod (smallestLargestArray) in

int[] resultsmallestLargestArray =
findSmallestAndLargest(numbe1, number2, number3);
System.out.println("Smallest number is: "+
resultsmallestLargestArray[0] +" and Largest number is "+
resultsmallestLargestArray[1] );
input.close();
}
}
